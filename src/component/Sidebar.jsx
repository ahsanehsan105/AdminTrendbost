...
export default function Sidebar() {
  ...
  const logoutHandler = () => {
    // Clear user authentication tokens or perform other logout tasks
    // For example, clearing local storage:
    localStorage.clear();
      ...
      <Drawer variant="permanent" open={open}>
        ...
        <List>
          {[
            ...
            { text: 'Profile Settings', icon: <SettingsIcon />, path: '/profile-settings' },
          ].map((item) => (
            <ListItem
              key={item.text}
              disablePadding
